...
public class GameView extends View {
	/*
	 * Synchronization policy.  A GameView contains a GameModel, gm,
	 * which is being accessed and modified by the GameLoop thread as well as the
	 * UI-thread in the onDraw and onTouchEvent methods..
	 * The only common points of contact are
	 *   - gm.size which is a final variable and hence threadsafe
	 *   - gm.actors which never changes after it is initialized
	 *     and so is also safe
	 *   - individual actors a in the gm.actors list
	 *     and we synchronize on these
	 *   - the gm.avatarMovement variable which we access through
	 *     gm.moveAvatar(dp) and which is a threadsafe call
	 */
